...
<br>
<div class="container">
  <form action="DeleteEventDatabase.php" method="POST">
  <div class="row">
    <div class="col-25">
      <label input="eventId">Enter Event ID to delete</label>
    </div>
    <div class="col-75">
      <input type="text" id="eventId" name="eventId" placeholder="Event ID..">
    </div>
  </div>
  <br></br>
  <div class="row">
