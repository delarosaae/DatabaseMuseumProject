...
$Supervises = "Select * from Curator";
$SupervisesList = mysqli_query($conn, $Supervises);

echo "<table><caption>Curator Supervises</caption><th>EmpID</th><th>WingID</th>"; 


while($row = mysqli_fetch_array($SupervisesList)){   
echo "<tr><td>" . $row['empId'] . "</td><td>" . $row['workingWing'] . "</td></tr>";  
}
